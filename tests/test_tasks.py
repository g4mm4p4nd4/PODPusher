...
def _load_tasks_module():
    ...
    _DummySQLModel.metadata = types.SimpleNamespace(
    ...
    _install_stub("services.ideation.service", {"generate_ideas": lambda *_a, **_k: []})
    _install_stub("services.image_gen.service", {"generate_images": lambda *_a, **_k: []})
    _install_stub(
    ...
    _install_stub("services.social_generator.service", {"generate_post": lambda *_a, **_k: {}})
